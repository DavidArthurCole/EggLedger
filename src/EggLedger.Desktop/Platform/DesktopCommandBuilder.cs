...
/// <summary>
/// Pure per-OS command construction for shell-out platform ops (open, reveal,
...
public static class DesktopCommandBuilder {
    ...
    /// <summary>
    /// Command to reveal path in the OS file browser. Windows: explorer /select,path
    ...
    /// <summary>
    /// Command to relaunch the exe at exePath (invoked directly, no args). Caller
    /// exits the current process after launching it.
    /// </summary>
