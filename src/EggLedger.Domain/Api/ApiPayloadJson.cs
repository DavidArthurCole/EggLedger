...
/// <summary>
/// JSON contract for the server-side decode transport; sync server and WASM client must use the
/// SAME options. Populate is required: protogen collection properties are get-only, so without it
